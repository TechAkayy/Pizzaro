...
<style scoped>@media (min-width:600px) {.avatar { position: absolute; right: 0; } }
</style>
<template>
    <v-app-bar flat color="#e8e7e7">
        <div class="d-flex justify-center" style="width: 100%">
            <v-tabs :model-value="currentRoute" hide-slider color="error">
                <v-tab title="Track Order" class="d-none d-sm-flex hidden-only text-subtitle-2" prepend-icon="material-symbols-search-rounded" to="/track" value="track">
</v-tab>
                ...
                <v-tab to="/order" value="order" class="d-sm-none text-h4" prepend-icon="ic-twotone-delivery-dining">
</v-tab>
            </v-tabs>
        </div>
        <v-avatar image="https://images.unsplash.com/photo-1494790108377-be9c29b29330?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwyMDkyMnwwfDF8c2VhcmNofDI5fHxwZXJzb258ZW58MHx8fHwxNjQ4NTQxMjc0&ixlib=rb-1.2.1&q=80&w=200" color="grey-darken-3" class="avatar"></v-avatar>
    </v-app-bar>
</template>
