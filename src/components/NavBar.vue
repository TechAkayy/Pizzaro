  ...
  <v-app-bar flat color="#e8e7e7">
    <div class="d-flex justify-center" style="width: 100%">
      <v-tabs :model-value="currentRoute" hide-slider color="error">
        <v-tab title="Track Order" class="d-none d-sm-flex hidden-only text-subtitle-2"
          prepend-icon="material-symbols-search-rounded" to="/track" value="track">
        </v-tab>
    ...
    <v-avatar
      ...
      color="grey-darken-3" class="avatar"></v-avatar>
  </v-app-bar>
</template>
