...
<template>
  <div data-pg-name="Promo">
    <div class="align-center d-flex flex-column justify-center">
      <p class="font-weight-bold mt-1 mt-md-3 mt-sm-2 text-center text-h5 text-md-h3 text-sm-h4"
        style="font-family: 'Playfair Display', serif !important">
        Famous hand tossed pizza </p>
    ...
    <div class="mt-2 mt-sm-4 promo-grid">
      <v-container style="grid-area: promos" class="bg-white">
        ...
        <v-row>
          <v-col v-for="(special, index) in specials" :key="index" class="justify-center">
            <PromoCard :special="special" data-pg-name="PromoCard" />
          </v-col>
        </v-row>
      </v-container>
      <v-container style="grid-area: free-delivery"
      ...
      <v-container style="grid-area: free-fries"
        ...
        <div class="align-center d-flex d-sm-block ml-2">
          ...
          <p class="d-none d-sm-block text-caption">
            Every friday we have free fries for every $20 order </p>
        </div>
        <div class="align-center bg-light-blue-darken-3 d-flex flex-column justify-center ml-2 pb-1 pl-2 pr-2 pt-1"
  ...
  <div data-pg-name="Menu">
    <v-row class="">
      <v-col>
        <p class="font-weight-bold mt-1 mt-md-3 mt-sm-2 text-h5 text-md-h3 text-sm-h4"
          style="font-family: 'Playfair Display', serif !important">
          Pizza Menu </p>
        <p class="mt-2 text-caption text-md-caption" style="max-width: 600px">
          Choose from our plethora of exquisite pizza creations </p>
      </v-col>
    </v-row>
    <v-row>
      <v-col>
        <v-row>
          <v-col v-for="(pizza, index) in pizzas" :key="index" class="justify-center">
